...
Source0  : https://files.pythonhosted.org/packages/e9/d8/36039649aa0e5fcb3a1b8864d541b36e7f822470fd302540b98fa2c36926/types-pytz-2022.5.0.0.tar.gz
...
%prep
%setup -q -n types-pytz-2022.5.0.0
cd %{_builddir}/types-pytz-2022.5.0.0
pushd ..
cp -a types-pytz-2022.5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666194065

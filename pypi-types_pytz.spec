...
Source0  : https://files.pythonhosted.org/packages/df/be/6e8a5f660845f2c756418969aadfeec5edd264f3d672c21b3d5ab0365457/types-pytz-2022.6.0.1.tar.gz
...
%prep
%setup -q -n types-pytz-2022.6.0.1
cd %{_builddir}/types-pytz-2022.6.0.1
pushd ..
cp -a types-pytz-2022.6.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667332284

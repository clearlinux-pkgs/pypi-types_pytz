...
Release  : 35
URL      : https://files.pythonhosted.org/packages/d1/80/0a2ef56b9977898789b7a0ab8d8ec32e19159e8c5d5aef203fccf4bbc4ed/types-pytz-2024.1.0.20240203.tar.gz
Source0  : https://files.pythonhosted.org/packages/d1/80/0a2ef56b9977898789b7a0ab8d8ec32e19159e8c5d5aef203fccf4bbc4ed/types-pytz-2024.1.0.20240203.tar.gz
...
%prep
%setup -q -n types-pytz-2024.1.0.20240203
cd %{_builddir}/types-pytz-2024.1.0.20240203
pushd ..
cp -a types-pytz-2024.1.0.20240203 buildavx2
popd
pushd ..
cp -a types-pytz-2024.1.0.20240203 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706999798
